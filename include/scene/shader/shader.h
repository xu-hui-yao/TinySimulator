...
public:
    explicit Shader(std::filesystem::path path) noexcept;
    ...
    void set_vector2(const char *name, const glm::vec2 &value) const noexcept;
    void set_vector3(const char *name, const glm::vec3 &value) const noexcept;
    void set_vector4(const char *name, const glm::vec4 &value) const noexcept;
...
private:
    ...
    std::filesystem::path m_tess_ctrl_path;
    std::filesystem::path m_tess_eval_path;
